...
4. Sistema: muestra de cada bolsín su CM origen y número de precinto, habilitando la selección de uno por listado o filtrando por alguno de estos datos.
5. EB: selecciona un bolsín del listado.
6. Sistema: para cada remito asociado al bolsín, muestra el número de remito y para cada documentación contenida en el remito muestra el asunto y el tipo de documentación.
...
11. Sistema: actualiza:
    • el bolsín al estado Recibido en CM destino, registrando el empleado responsable,
    • los remitos al estado Recibido y Aceptado
    • la documentación asociada al estado Recibida y Aceptada, registrando el empleado responsable.
12. Sistema: para enviar notificación a cada CM de origen que envió documentación, sobre la recepción del bolsín y la situación de la documentación recibida (leer Obs. 2), se incluye al caso de uso 29. Notificar recepción de bolsín. Informa de la ejecución exitosa del caso de uso. Fin del caso de uso.